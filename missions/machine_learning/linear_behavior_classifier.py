...
if __name__ == "__main__":
  ...
  parser.add_argument(
      "--train_data",
      type=str,
      default="/Users/Gupta/moos-ivp-argupta/missions/defend/results_dataset/train_1/train.csv",
      help="Path to the training data."
  )
  parser.add_argument(
      "--test_data",
      type=str,
      default="/Users/Gupta/moos-ivp-argupta/missions/defend/results_dataset/train_1/test.csv",
